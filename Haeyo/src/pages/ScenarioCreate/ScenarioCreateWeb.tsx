...
import styles from './ScenarioCreateWeb.module.css';

export const ScenarioCreateWeb = () => {
          ...
          <div className={styles.pageHeader}>
            <button className={styles.backBtn} onClick={() => navigate(-1)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M19 11H7.83L13.42 5.41L12 4L4 12L12 20L13.41 18.59L7.83 13H19V11Z" fill="#000000"/>
              </svg>
            </button>
            <h1 className={styles.pageTitle}>시나리오 생성</h1>
          </div>
          ...
          <div className={styles.formContainer}>
            ...
            <div className={styles.formGroup}>
              <label className={styles.label}>
                시나리오 제목 <span className={styles.required}>*</span>
              </label>
              <input
                type="text"
            ...
            <div className={styles.formGroup}>
              <label className={styles.label}>
                제보 불러오기 <span className={styles.required}>*</span>
              </label>
              {isLoadingReports ? (
                ...
                <div className={styles.reportCard}>
                  <div className={styles.reportIcon}>
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                      ...
                      <path d="M20 10V23M20 27V30" stroke="white" strokeWidth="2.5" strokeLinecap="round"/>
                    </svg>
                  </div>
            ...
            <div className={styles.formGroup}>
              <label className={styles.label}>
                시나리오 상황 <span className={styles.required}>*</span>
              </label>
              <textarea
              ...
              <div className={styles.dateTimeRow}>
                <div className={styles.dateInputWrapper}>
                  ...
                  <svg className={styles.inputIcon} width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M19 3H18V1H16V3H8V1H6V3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM19 19H5V8H19V19Z" fill="#6b7280"/>
                  </svg>
                </div>
                <div className={styles.timeInputWrapper}>
                  ...
                  />
                  <svg className={styles.inputIcon} width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20ZM12.5 7H11V13L16.2 16.2L17 14.9L12.5 12.2V7Z" fill="#6b7280"/>
                  </svg>
                </div>
              </div>
