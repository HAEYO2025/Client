...
import styles from './ScenarioResultWeb.module.css';
...
export const ScenarioResultWeb = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        {(currentPage?.situation || isStreaming) && (
          <div
            ref={situationRef}
          ...
          >
            {currentPage?.situation ? (
              ...
              <p className={styles.situationPlaceholder}>시나리오 생성 중...</p>
            )}
          </div>
        )}
